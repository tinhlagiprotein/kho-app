...
<body>
        ...
        <div class="cats-grid" id="appList">
            ...
            <div class="cat-card" data-cat="<?= htmlspecialchars($cat['title']) ?>">
                ...
                <div class="cat-items">
                    ...
                    <div class="app-item">
                        <div class="app-avatar <?= htmlspecialchars($app['color']) ?>">
                            <?= htmlspecialchars($app['abbr']) ?>
                        </div>
                        <div class="app-info">
                            <div class="app-name">
                            ...
                            <div class="app-meta">
                                <?= htmlspecialchars($app['ver']) ?> • <?= htmlspecialchars($app['tag']) ?>
                            </div>
                        </div>
    ...
    <nav class="bottom-nav">
        ...
        <div class="nav-item">
            <span class="nav-icon">📦</span><span>Kho app</span>
        </div>
        <div class="nav-item">
            <span class="nav-icon">⬇</span><span>Đã tải</span>
        </div>
        <div class="nav-item">
            <span class="nav-icon">⚙</span><span>Cài đặt</span>
        </div>
    </nav>
    ...
    <div class="copy-modal" id="copyModal">
        <div class="copy-box">
            <div class="copy-title">
                🔗 Link tải: <span id="modalAppName"></span>
            </div>
